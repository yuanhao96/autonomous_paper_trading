...
RESULTS_FACTORS_XS_OPT = PROJECT_ROOT / "results_factors_xs_opt.json"
RESULTS_SCREEN = PROJECT_ROOT / "results_screen.json"
RESULTS_SCORE = PROJECT_ROOT / "results_score.json"
RESULTS_VALIDATE = PROJECT_ROOT / "results_validate.json"
RESULTS_ALLOCATE = PROJECT_ROOT / "results_allocate.json"
